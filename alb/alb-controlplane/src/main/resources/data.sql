MERGE INTO alb_upstream (id, name, target_url, websocket_enabled, remark) KEY(id) VALUES
...
MERGE INTO alb_route (id, env, host, path_pattern, priority, upstream_id, enabled, redirect_url, system_locked, remark) KEY(id) VALUES
